document.addEventListener('DOMContentLoaded', () => {
    ...
    const MAX_SELECTION = 6; // 선택할 번호 개수는 고정
    ...
    autoSelectBtn.addEventListener('click', () => {
        ...
        // 섞인 배열에서 6개 선택
        // 만약 currentMaxNumber가 MAX_SELECTION(6)보다 작으면, currentMaxNumber만큼만 선택
        const numbersToSelect = Math.min(MAX_SELECTION, currentMaxNumber);
